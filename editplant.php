    ...
    function validate_submit() {
        ...
        */
        ...
        if($post) {
            ...
            if(empty($data['CommonName']) && empty($data['ScientificName']))
                $form_errors[] = "Please Provide a Name";
			if(empty($data["Color"])) 
				$form_errors[] = "Please Select a Color";
    ...
    <div class="panel-body">
        <form method="POST">
          ...
          <div class="form-group">
            ...
            <input name="CommonName" type="text" class="form-control"placeholder="" value="<?php echo_data("CommonName");?>">
          </div>
		  
          <div class="form-group">
            <label for="ScientificName">Scientific Name</label>
            <input name="ScientificName" type="text" class="form-control"placeholder="" value="<?php echo_data("ScientificName");?>">
          </div>
